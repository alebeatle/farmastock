...
<head>
  ...
  .scrollable-menu {
    ...
    overflow-x: hidden;
      ...
      .main {
          background-image: url(fondos/fondo4.jpg) !important;
  ...
  .navbar li a, .navbar .navbar-brand {
      ...
      background-color: #435312  !important;
  }
...
<div class="row panels-row">
 ...
 <form action="guardarMax1.php" method="post" style="bg-5" align="center"   ">    
                 ...
                 {   //   $query = " SELECT id, Nombre, Cant_Max, Stock FROM `medicamentos` ";
                     ...
                     //  echo " <td>  ".$row[4] ."</td> ";
                      ...
                      // echo "  <td><input type="text" name="monto10" maxlength="2" size="2"  style="background-color:grey;"/> </td> "; 
                       echo '<td><input class="text" onfocus="this.select();"  type="text" maxlength="3" size="3" name="monto'.$i.'" value="'.$row[2] .'"style="background-color:grey;"></td>';
...
<div class="row panels-row">
 ...
 <form action="guardarMax2.php" method="post" style="bg-5" align="center"   ">    
...
<div class="row panels-row">
 ...
 <form action="guardarMax3.php" method="post" style="bg-5" align="center"   ">    
...
<div class="row panels-row">
 ...
 <form action="guardarMax4.php" method="post" style="bg-5" align="center"   ">    
...
<div class="row panels-row">
 ...
 <form action="guardarMax5.php" method="post" style="bg-5" align="center"   ">    
...
<div class="row panels-row">
 ...
 <form action="guardarMax6.php" method="post" style="bg-5" align="center"   ">    
...
<div class="row panels-row">
 ...
 <form action="guardarMax7.php" method="post" style="bg-5" align="center"   ">    
...
<div class="row panels-row">
 ...
 <form action="guardarMax8.php" method="post" style="bg-5" align="center"   ">    
...
<div class="row panels-row">
 ...
 <form action="guardarMax9.php" method="post" style="bg-5" align="center"   ">    
...
<div class="row panels-row">
 ...
 <form action="guardarMax10.php" method="post" style="bg-5" align="center"   ">    
...
<div class="row panels-row">
 ...
 <form action="guardarMax11.php" method="post" style="bg-5" align="center"   ">    
...
<div class="row panels-row">
 ...
 <form action="guardarMax12.php" method="post" style="bg-5" align="center"   ">    
...
<div class="row panels-row">
 ...
 <form action="guardarMax13.php" method="post" style="bg-5" align="center"   ">    
...
<div class="row panels-row">
 ...
 <form action="guardarMax14.php" method="post" style="bg-5" align="center"   ">    
...
<div class="row panels-row">
 ...
 <form action="guardarMax15.php" method="post" style="bg-5" align="center"   ">    
...
<div class="row panels-row">
 ...
 <form action="guardarMax16.php" method="post" style="bg-5" align="center"   ">    
...
<div class="row panels-row">
 ...
 <form action="guardarMax17.php" method="post" style="bg-5" align="center"   ">    
...
<div class="row panels-row">
 ...
 <form action="guardarMax18.php" method="post" style="bg-5" align="center"   ">    
...
<div class="row panels-row">
 ...
 <form action="guardarMaxJ1.php" method="post" style="bg-5" align="center"   ">    
...
<div class="row panels-row">
 ...
 <form action="guardarMaxJ2.php" method="post" style="bg-5" align="center"   ">    
...
<div class="row panels-row">
 ...
 <form action="guardarMaxJ3.php" method="post" style="bg-5" align="center"   ">    
...
<div class="row panels-row">
 ...
 <form action="guardarMaxJ4.php" method="post" style="bg-5" align="center"   ">    
...
<div class="row panels-row">
 ...
 <form action="guardarMaxR.php" method="post" style="bg-5" align="center"   ">    
...
<div class="row panels-row">
 ...
 <form action="guardarMaxh.php" method="post" style="bg-5" align="center"   ">    
...
<div class="row panels-row">
 ...
 <form action="guardarMaxG.php" method="post" style="bg-5" align="center"   ">    
...
<div class="row panels-row">
 ...
 <form action="guardarMaxGP.php" method="post" style="bg-5" align="center"   ">    
...
<td> <button type="submit" name="btn-guardar1" class="btn btn-info"><strong>Guardar</strong></button></td>
 ...
 <!-- Hasta Aqui GENERICOS PAMI VIA FORX------------------------------------------------------------------------------------------>
...
<td> <button type="submit" name="btn-guardar1" class="btn btn-info"><strong>Guardar</strong></button></td>
 ...
 <!-- Hasta Aqui GENERICOS PAMI ---------------------------->
 
 <!--  DESDE AQUI CADA Mostraodr  --------------------------->
...
<div class="row panels-row">
 ...
 <form action="guardarMaxM.php" method="post" style="bg-5" align="center"   ">    
...
<td> <button type="submit" name="btn-guardar1" class="btn btn-info"><strong>Guardar</strong></button></td>
 ...
 <!-- Hasta Aqui Mostrador ---------------------------->

 
  <!--  DESDE AQUI CADA Blistera Comp vit  --------------------------->
 

 <a name="b1"></a>
<br></br>
     <h2>Max Blistera Comp Vit </h2> 
...
<div class="row panels-row">
 ...
 <form action="guardarMaxB.php" method="post" style="bg-5" align="center"   ">    
