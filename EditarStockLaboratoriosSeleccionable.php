  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
         ...
         <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">Laboratorios <b class="caret"></b></a>
          <!-- <ul class="dropdown-menu">   ------------------------>    
              <ul class="dropdown-menu scrollable-menu" role="menu">
                <li><a href="Alquileres.htm">Andromaco</a></li>
                <li><a href="Gastronomia.htm">Bago</a></li>
                <li><a href="Entretenimiento.htm">Cassal</a></li>
                <li><a href="#">Action</a></li>
                    ...
                    <li><a href="#">Another action</a></li>
                <li class="divider"></li>
                <li><a href="Actividad.htm">Actividad comercial</a></li>
              </ul>
            </li>
